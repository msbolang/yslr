...
class BasicConfig extends ConfigForm
{
	...
	public $sys_site_name;
        public $sys_site_name_en;
	public $sys_site_description;
        public $sys_site_description_en;
	public $sys_site_about;
        public $sys_site_about_en;
	public $sys_site_url;
    ...
    {
        return [
            [['sys_site_name','sys_site_name_en', 'sys_site_description', 'sys_site_description_en','sys_site_about','sys_site_about_en', 'sys_site_url', 
    ...
    public function attributeLabels()
    {
        return [
            'sys_site_name' => '网站名称',
                'sys_site_name_en' => '网站名称_英文',
            'sys_site_description' => '网站描述',
              'sys_site_description_en' => '网站描述_英文',
            'sys_site_about' => '关于',
              'sys_site_about_en' => '关于_英文',
            //'sys_site_url' => '网站Url',
