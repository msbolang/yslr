...
$AppLan = Yii::$app->language;
if($AppLan=='en'){
  $sys_seo_keywords = $this->getConfigValue('sys_seo_keywords_en');
  $sys_seo_description = $this->getConfigValue('sys_seo_description_en');
  $title = $this->getConfigValue('sys_site_name_en');
  $this->title = 'INDEX';
  $usr_reg = 'register';
  $usr_login = 'login';
  $usr_logout = 'logout';
    ...
    if(empty($title))
    {
      ...
      $sys_seo_keywords = $this->getConfigValue('sys_seo_keywords');
...
<head>
    ...
    <meta name="keywords" content="<?php echo $sys_seo_keywords ?>">
    <meta name="description" content="<?php echo $sys_seo_description ?>">
                            ...
                            <div class="span9">
                                ...
                                <nav class="nav nav__primary clearfix">
                                    <ul id="topnav" class="sf-menu">
                                        <?php $this->renderMenu();?>
                                        <li id="menu-item-yiifans" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-yiifans"></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
